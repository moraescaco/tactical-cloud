...
def page_cash():
    ...
    cash_section = st.radio("Área do caixa", ["Caixa atual", "Histórico de caixas"], horizontal=True, key="cash_section")
...
def page_commands():
    ...
    command_section = st.radio(
        "Área de comandas",
        ["1. Abrir comanda", "2. Operar comanda", "3. Histórico"],
        horizontal=True,
        key="commands_section",
    )
...
def page_stock():
    ...
    stock_section = st.radio("Área de estoque", ["Entrada de Estoque", "Movimentações"], horizontal=True, key="stock_section")
